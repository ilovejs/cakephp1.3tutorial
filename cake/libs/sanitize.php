 ...
 */
	...
	function clean_up_msword($str){
		$str = str_replace(chr(32), ' ', $str);    // empty space
		...
		$str = str_replace(chr(150), '&ndash;', $str);    // endash
		$str = str_replace(chr(151), '&mdash;', $str);   // emdash
		$str = str_replace(chr(152), '~', $str);    // tilde accent
		$str = str_replace(chr(153), '(TM)', $str); // trademark ligature
		$str = str_replace(chr(154), 'sh', $str);   // s Hacek
		$str = str_replace(chr(155), '>', $str);    // right single guillemet
		$str = str_replace(chr(159), 'Y', $str);    // Y Dieresis
		$str = str_replace(chr(160), ' ', $str);    // Celcius*/
		$str = str_replace(chr(169), '&deg;C', $str);    // Celcius
		$str = str_replace(chr(163), '&pound;', $str);    // Celcius
		$str = str_replace(chr(174), '&reg;', $str);
		$str = str_replace(chr(180), '&#180;', $str);
		$str = str_replace(chr(153), '&trade;', $str);
		$str = str_replace(chr(228), '&#228;', $str); //ä 	228
